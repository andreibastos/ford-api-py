...
FORD_PATH = '/home/labic/Downloads/ford_9470/'
...
class Twitter(threading.Thread):
    ...
    def make_arguments(self):
        ...
        for argument in self.arguments.keys():
            if self.arguments.get(argument):
                arguments_str = arguments_str + " --" +argument + " "+ str(self.arguments.get(argument))
        return arguments_str
    
    def terms(self):
        arguments_str = self.make_arguments()
        command = FORD_PATH+"ford.py -t --twitter-data tweets -o {0} {1} -n 100 -q".format(self.arguments.get("output"),arguments_str )
        try:
    ...
    def run(self):
        if self.collect_type is "collect":
            data = self.arguments.get("twitter-data")
            if data is "tweets":
                self.terms()                
...
arguments1 = {"input":"dilma", "output":"coletas/dilma", "twitter-data":"tweets", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
arguments2 = {"input":"lula", "output":"coletas/lula", "twitter-data":"tweet_ids", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
arguments3 = {"input":"enem", "output":"coletas/enem", "twitter-data":"timelines", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
arguments4 = {"input":"dica", "output":"coletas/dica", "twitter-data":"friends", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
arguments5 = {"input":"wifi", "output":"coletas/wifi", "twitter-data":"followers", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
arguments6 = {"input":"politica", "output":"coletas/politica", "twitter-data":"retweets", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
arguments7 = {"input":"agua", "output":"coletas/agua", "twitter-data":"replies", "minimum":None, "maximum":None, "days":1, "geocodes":[], "lang":"pt", "number":None}
